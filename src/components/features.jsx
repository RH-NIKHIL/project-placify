...
const cardData = [
  ...
  },
  {
    color: '#060010',
    title: 'Collaboration',
    description: 'Work We believe in the power of collaboration — where diverse minds come together, share ideas, and build solutions as one team. ',
    label: 'Teamwork'
  },
  {
    color: '#060010',
    title: 'Efficiency',
    description: ' we ensure students are well-prepared to excel in their professional journey.',
    label: 'Placement'
  },
  {
    color: '#060010',
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-1 p-3 max-w-[70rem] select-none relative"
